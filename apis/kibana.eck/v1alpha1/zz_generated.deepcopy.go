...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KibanaInstanceSpec) DeepCopyInto(out *KibanaInstanceSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KibanaInstanceSpec.
func (in *KibanaInstanceSpec) DeepCopy() *KibanaInstanceSpec {
	if in == nil {
		return nil
	}
	out := new(KibanaInstanceSpec)
	in.DeepCopyInto(out)
	return out
}
