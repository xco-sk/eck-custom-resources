...
func (r *SnapshotRepositoryReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if snapshotRepository.Spec.CommonConfig != nil && snapshotRepository.Spec.CommonConfig.ElasticsearchInstance != nil {
		var resourceInstance eseckv1alpha1.ElasticsearchInstance
		if err := esutils.GetTargetElasticsearchInstance(r.Client, ctx, req.Namespace, *snapshotRepository.Spec.CommonConfig.ElasticsearchInstance, &resourceInstance); err != nil {
