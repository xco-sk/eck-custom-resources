...
func (r *LensReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	targetInstance, err := r.getTargetInstance(&lens, lens.Spec.CommonConfig, ctx, req.Namespace)
	if err != nil {
...
func (r *LensReconciler) getTargetInstance(object runtime.Object, commonConfig *kibanaeckv1alpha1.CommonKibanaConfig, ctx context.Context, namespace string) (*configv2.KibanaSpec, error) {
